/**
 * Defines a generic HTTP DELETE REST client.
 */
...
if(Meteor.isServer) {
	Meteor.methods({
		...
		deleteResource(isLive, endpoint, customerId, resourceId1, resourceId2, resourceId3){ 
			this.unblock();   
